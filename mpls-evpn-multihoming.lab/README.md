...
_В качестве топологии используется следующая схема:
...
_Теперь очередь за настройкой Multihoming. Этим самым я повышаю:
...
_Как видно, PE-01 может отправлять BUM трафик в сторону Ethernet сегмента, в отличие от PE-02
